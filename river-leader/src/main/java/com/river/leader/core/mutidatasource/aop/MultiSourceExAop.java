package com.river.leader.core.mutidatasource.aop;

import com.river.leader.config.properties.MutiDataSourceProperties;
import com.river.leader.core.mutidatasource.DataSourceContextHolder;
...
public class MultiSourceExAop implements Ordered {
    ...
    @Pointcut(value = "@annotation(com.river.leader.core.mutidatasource.annotion.DataSource)")
    private void cut() {
