package com.river.leader.core.common.warpper;
...
public abstract class BaseControllerWrapper {
    ...
    private PageResultPlus<Map<String, Object>> pageResult = null;
    ...
    public BaseControllerWrapper(PageResultPlus<Map<String, Object>> pageResult) {
